...
"[project]/app/actions/create-listing.ts [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function CreateListingPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$create$2d$listing$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createListing"])({
                agent_id: user.id,
                category_id: formData.category_id,
                address: formData.address,
                city: formData.city,
            ...
            if (listing) {
                    ...
                    for (const file of folderFiles){
                        try {
                            ...
                            if (uploadResponse.ok) {
                                ...
                                const saveResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$create$2d$listing$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveListingFile"])({
                ...
                if (firstImageUrl && !formData.thumbnail_url) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$create$2d$listing$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateListingThumbnail"])(listing.id, firstImageUrl);
                }
            }
...
//# sourceMappingURL=_0d931bf4._.js.map